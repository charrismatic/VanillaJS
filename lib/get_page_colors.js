...
(function () {
  ...
  [].forEach.call(document.querySelectorAll("*"), function (node) {
    ...
    props.forEach(function (prop) {
      ...
      var thisIsABorderProperty = (prop.indexOf("border") != -1);
      var notBorderZero = thisIsABorderProperty ? window.getComputedStyle(node, null).getPropertyValue(prop.replace("color", "width")) !== "0px" : true;
      var colorConditionsMet;
